...
<head>
    ...
    <title>Glow Beauty - About Us</title>
    <!-- Bootstrap 5 CSS -->
...
<section class="hero">
    <div class="container">
        <div class="hero-content">
            <?php
            $about_description_content = get_content('about', 'description');
            if ($about_description_content) {
                echo $about_description_content;
            } else {
                echo '<h1>About Us</h1>
                      <p>Learn more about Glow Beauty.</p>';
            }
            ?>
        </div>
    </div>
...
<div class="content-wrapper">
    <div class="container">
        <main>
            ...
            <p class="section-subtitle">Learn more about Glow Beauty</p>
        </main>
    </div>
</div>
